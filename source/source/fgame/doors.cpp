...
CLASS_DECLARATION( ScriptSlave, Door, "NormalDoor" )
	{
		...
		//{ &EV_InventoryItem_Use, Use }, //multiple occurences fixed
...
void Door::SetDir
   ...
   localAngle = ev->GetFloat( 1 );
   dir = G_GetMovedir( localAngle );
	t = dir[ 0 ];
	dir[ 0 ] = -dir[ 1 ];
	dir[ 1 ] = t;
   }
...
CLASS_DECLARATION( Door, RotatingDoor, "func_rotatingdoor" )
	{
		//chrissstrahl - code incompatibility fix
		//{ &EV_Door_DoClose, &DoClose } //multiple occurences fixed
...
void SlidingDoor::SetMoveDir
   ...
   localAngle = ev->GetFloat( 1 );
	movedir = G_GetMovedir( localAngle );
   dir = movedir;
	t = dir[ 0 ];
	dir[ 0 ] = -dir[ 1 ];
	dir[ 1 ] = t;
...
CLASS_DECLARATION( Door, ScriptDoor, "script_door" )
	{
		//chrissstrahl - code incompatibility fix
		//{ &EV_ScriptDoor_DoInit,	&DoInit }, //multiple occurences fixed
