...
class Weapon : public Item
   ...
   protected:
	  ...
	  //func seams to not exist ?
	  //void                 SetSecondaryAmmo(const char *type, int localAmount, int startamount);
      //void                 SetSecondaryAmmo( const char *type, int amount, int startamount );
      friend               class Player;
      void			         DetachGun( void );
	  //chrissstrahl - code incompatibility fix
      void			         AttachGun( weaponhand_t localHand, qboolean holstering=qfalse ); 
   ...
   public:
      ...
      void			       SetAmmoAmount( int localAmount, firemode_t mode ); //chrissstrahl - code incompatibility fix
      //void			   SetAmmoAmount( int amount, firemode_t mode );
      void                 UseAmmo( int localAmount, firemode_t mode ); //chrissstrahl - code incompatibility fix
      ...
      inline virtual void  SpecialFireProjectile( Vector pos, Vector forward, Vector right, Vector up, Entity *localOwner, str localProjectileModel, float localCharge_fraction ) {}; //chrissstrahl - code incompatibility fix
      ...
      void                 WorldHitSpawn( firemode_t mode, Vector org, Vector localAngles, float life ); //chrissstrahl - code incompatibility fix
