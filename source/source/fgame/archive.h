...
inline qboolean Archiver::Read( str &name, qboolean localHarderror )
   {
   return Read( name.c_str(), localHarderror );
   }

//chrissstrahl - code incompatibility fix
//inline qboolean Archiver::Create(str &name, qboolean harderror )
inline qboolean Archiver::Create(str &name, qboolean localHarderror )
   {
   return Create( name.c_str(), localHarderror );
   }
